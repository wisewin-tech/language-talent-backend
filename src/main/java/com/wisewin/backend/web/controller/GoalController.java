...
public class GoalController extends BaseCotroller {
    ...
    public void queryGoal(HttpServletRequest request, HttpServletResponse response, String ppPurpose, Integer adminId, Date ppReleasetime, Date ppUpdatetime){

        List<GoalBO> list=goalService.getqueryGoal(ppPurpose,adminId,ppReleasetime,ppUpdatetime);
